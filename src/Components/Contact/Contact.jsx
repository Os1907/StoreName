...
export default function Contact() {
  return (
    <>
      <section className=" flex justify-center items-center lg:pb-28 lg:pt-36 h-[90vh] lg:h-auto ">
        <div className="mx-auto w-[80%] flex justify-center items-center  flex-col lg:flex-row ">
          <Iframe
            ...
            className="md:size-96 lg:ml-28 w-[250px] h-[250px] rounded-[5px] mt-20 lg:mt-0 "
            loading="eager"
            referrerpolicy="no-referrer-when-downgrade"
          ></Iframe>

          <div className=" lg:ml-16  flex flex-col justify-center  lg:mt-0 mt-10">
            <h2 className="mb-4 md:text-5xl text-2xl  font-bold mainText  mb-0 lg:text-left text-center">
              Contact us
            </h2>
            <div className="xl:mr-24 text-[10px] md:text-base  ">
              <nav className="text-[#0A0A0A]  text-[17px] font-medium   lg:my-4 lg:col-span-2 sm:col-span-6 col-span-8  flex item-center flex-col  text-left">
                <p className="link link-hover md:text-left text-center line-clamp-1 ">
                  497 Evergreen Rd. Roseville, CA 95673{" "}
                </p>
                <p className="link link-hover my-2 lg:text-left text-center">+44 345 678 903</p>
                <p className="link link-hover lg:text-left text-center"> adobexd@mail.com</p>
              </nav>
              <div className=' ml-[-20px] flex justify-center lg:justify-start my-4 '>
                <div className="flex items-center ">
                  ...
                  />
                  <p className="link link-hover ml-1"> Facebook</p>
                </div>
                <div className="flex items-center  ">
                  <img
                    src={twitter}
